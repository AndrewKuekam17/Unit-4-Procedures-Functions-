...
{
    public partial class frmPassbyReferenceandClickEvents : Form
    {
        // declare global variables
        Random randomGenerator = new Random();
        const int MAX_CARDS = 52;

        public frmPassbyReferenceandClickEvents()
        {
            InitializeComponent();
        }
        ...
        private void picCard_Click(object sender, EventArgs e)
        {
            ...
            // Call the function to Change the card
            ChangeCard(ref this.picCard, randomNumber);
        }
    }
}
